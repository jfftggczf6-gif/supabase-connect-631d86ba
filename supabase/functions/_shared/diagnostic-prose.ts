...
//
// ⚠️ MIROIR : src/lib/diagnostic-prose.ts porte la même liste (source de référence).
// Deno ne peut pas importer depuis src/. Ce fichier en est la copie stricte ;
// toute modification doit partir de src/ — le test compare les deux listes.
