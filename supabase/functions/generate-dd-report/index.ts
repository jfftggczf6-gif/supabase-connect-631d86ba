// generate-dd-report — Wrapper dispatch vers esono-ai-worker (Railway).
...
serve(async (req: Request) => {
  ...
  try {
    ...
    return jsonResponse({
      ...
      message: "DD report lancé sur Railway. checklist + findings seront insérés quand prêt.",
    }, 202);
  } catch (err: any) {
