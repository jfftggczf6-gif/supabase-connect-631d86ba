// generate-pe-valuation — Wrapper dispatch vers esono-ai-worker (Railway).
...
serve(async (req: Request) => {
  ...
  try {
    ...
    return jsonResponse({
      ...
      message: "Valuation lancée sur Railway. La table pe_valuation sera mise à jour quand prêt.",
    }, 202);
  } catch (err: any) {
