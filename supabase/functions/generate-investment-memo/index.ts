...
${MEMO_SCHEMA_PART2}`;
          ...
          const part2 = await callAI(injectGuardrails(MEMO_SYSTEM_PROMPT, ent.country), prompt2 + coachingContext, 16384, SONNET_MODEL, 0.15);
...
${MEMO_SCHEMA_PART1}`;
          ...
          const part1Result = await callAI(injectGuardrails(MEMO_SYSTEM_PROMPT, ent.country), prompt1 + coachingContext, 16384, SONNET_MODEL, 0.15);
