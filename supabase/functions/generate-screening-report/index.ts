...
import {
  ...
  jsonResponse, errorResponse, getDocumentContentForAgent, getCoachingContext, getKnowledgeForAgent, getFiscalParams, preloadFiscalParams,
...
serve(async (req) => {
  ...
  try {
    ...
    const planOvoData = getDelivData("plan_financier") || getDelivData("plan_ovo");
