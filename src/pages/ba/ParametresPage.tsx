...
// Route /ba/parametres — Partner only.
// 4 onglets : Fonds · Devise & formats · Critères · Thèse.
// Brief parametres_ba (Ordre 5).
...
import FundIdentitySection from '@/components/ba/parametres/FundIdentitySection';
import DeviseFormatsSection from '@/components/ba/parametres/DeviseFormatsSection';
import CriteresSection from '@/components/ba/parametres/CriteresSection';
import TheseSection from '@/components/ba/parametres/TheseSection';
...
export default function ParametresPage() {
  ...
  return (
    <DashboardLayout title="Paramètres" subtitle="Configuration du fonds — utilisée par l'IA et les exports">
      {error && (
