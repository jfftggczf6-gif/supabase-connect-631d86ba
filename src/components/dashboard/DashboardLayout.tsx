...
import { LogOut, User, Users, ClipboardList, Globe, ChevronDown, Check, Building2, Settings, BarChart3, BookOpen, Database, KeyRound, UserPlus } from 'lucide-react';
                ...
                <DropdownMenuContent align="start" className="w-64">
                  ...
                  {isSuperAdmin && (
                    <>
                      ...
                      <DropdownMenuItem onClick={() => navigate('/admin/add-entrepreneur')} className="gap-2 text-xs">
                        <UserPlus className="h-3.5 w-3.5" /> Ajouter un entrepreneur
                      </DropdownMenuItem>
                    </>
                  )}
                </DropdownMenuContent>
