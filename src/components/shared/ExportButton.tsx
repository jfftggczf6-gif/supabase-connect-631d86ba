// shared/ExportButton — Bouton dropdown qui invoque l'edge fn render-document
// pour télécharger un livrable (memo/valuation/pre-screening/dd) en multi-formats.
//
// Brief #38 [CROSS] Mutualiser composants communs PE + BA. Avant : PeExportButton
// dans /pe/ (utilisé aussi par BA via MemoSectionsViewer et PeValuationView).
// Maintenant partagé : 1 seul point de maintenance.
...
import {
  Download, FileText, Presentation, FileSpreadsheet, FileType, Loader2,
...
export type RenderKind = 'memo_ic1' | 'valuation' | 'pre_screening' | 'dd_report';
...
export default function ExportButton({
  dealId, kind, label, variant = 'outline', size = 'sm', iconOnly = false,
}: Props) {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-60">
        ...
        {/* memo_ic1 : option dédiée pour régénérer le slide payload IA */}
        {kind === 'memo_ic1' && (
          <>
            <DropdownMenuSeparator />
            <DropdownMenuItem
