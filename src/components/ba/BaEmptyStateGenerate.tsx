// BaEmptyStateGenerate — Empty state centré "✨ Générer..." aligné PE.
// Réutilisable par PreScreening / Memo / Valuation / Teaser quand le viewer est vide.
// Brief P7 ordre 26.
...
export default function BaEmptyStateGenerate({
  dealId, edgeFunction, label, description, toastLabel, onLaunched,
}: Props) {
