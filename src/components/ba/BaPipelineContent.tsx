...
//   - investment_manager (Senior) : voit mandats des analystes assignés + vue conso S3
//   - managing_director / owner / admin / partner : voit tout
...
export default function BaPipelineContent() {
